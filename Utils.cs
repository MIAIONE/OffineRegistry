...
namespace OffineRegistry
{
    ...
    {
        /// <summary>
        /// Represents the encoding used by Windows Registry. UTF-16 is valid for Windows 2000 and forward.
        /// </summary>
        ...
        /// <summary>
        /// The number of bytes for a single character in UTF-16. Commonly used to pad byte arrays /
        /// sizes with nulls
        /// </summary>
        ...
        /// <returns>
        /// Indication if the parsed data could be parsed correctly as the specified type. If false,
        /// data is always a byte[].
        /// </returns>
